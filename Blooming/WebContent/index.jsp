    ...
    <header class="slider-main">
        <div id="carouselExampleIndicators" class="carousel slide carousel-fade" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
               ...
               <div class="carousel-item active" style="background-image: url('images/ms.jpg')">
                  <div class="carousel-caption d-none d-md-block">
                     <h4>​The happiness will undoubtedly be realized<br><br>반드시 오고야 말 행복<br><br></h4>
                     <p> - 메리골드의 꽃말</p>
                  </div>
               </div>
               ...
               <div class="carousel-item" style="background-image: url('images/forest.jpg')">
                  <div class="carousel-caption d-none d-md-block">
                     <h4>씨앗, 너무 애쓰지마<br><br> 너는 본디 꽃이 될 운명일지니<br><br></h4>
                     <p> - 박광수, 앗싸라비아 中</p>
                  </div>
               </div>
               <!-- Slide Three - Set the background image for this slide in the line below -->
               <div class="carousel-item" style="background-image: url('images/kids.jpg')">
                  <div class="carousel-caption d-none d-md-block">
                     <h4>그대도 오늘 <br><br>누군가에게 위로였다<br><br></h4>
                     <p> - 이훤, 그대도 오늘 中</p>
                  </div>
               </div>
            </div>
    ...
    <div class="about-main">
            ...
            <div class="col-lg-6">
               ...
               <div class="col-lg-6">
                  ...
                  <p>Futura, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            ...
            <div class="row">
               ...
               <div class="col-lg-4 mb-4">
                  <div class="card h-100">
                     ...
                     <div class="card-body">
                        <p class="card-text">머신러닝을 기반으로 당신의 하루의 <br>감성을 분석해드립니다.</p>
                     </div>
                     <div class="card-footer">
               ...
               <div class="col-lg-4 mb-4">
                  <div class="card h-100">
                     ...
                     <div class="card-body">
                        <p class="card-text">보안성이 높은 ZOOM 프로그램으로<br>전문상담사가 고민을 들어드립니다.</p>
                     </div>
                     <div class="card-footer">
        ...
        <div class="row mb-4">
            ...
            <div class="col-md-4">
               <a class="btn btn-lg btn-secondary btn-block" href="signup.html">회원가입 하러가기</a>
            </div>
        </div>
    </div>
    <!-- /.container -->
