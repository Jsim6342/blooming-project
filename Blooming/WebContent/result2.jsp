...
<!-- Page Content -->
    <div class="container">
     ...
     <div class="about-main">
			<div class="row">
				<div class="col-lg-6">
					<h2>당신은 현재 가벼운 우울상태입니다.</h2>
					<p>하지만 우울 상태라고 우울증이란 뜻은 아닙니다.<br>어떤 일이 있을 때 슬픈 정도의 감정을 느끼는 정도의 감정상태일 뿐입니다.</p>
					<h5>혹시 걱정되시나요 ?</h5>
					<ul>
					...
					<p>가볍지만 우울상태라고 나와서 걱정되시나요.<br>사람의 생각에 따라 충분히 감정은 바뀔 수 있습니다.<br>저희가 제공하는 감정일기를 통해 새로운 동기부여를 만들어 보는 건 어떠신가요.
					</p>
				</div>
				<div class="col-lg-6">
