...
<!-- Page Content -->
    <div class="container">
     ...
     <div class="about-main">
			<div class="row">
				<div class="col-lg-6">
					<h2>당신은 현재 중한 우울상태입니다.</h2>
					<p>혹시 현재의 기분 상태를 가볍게 생각하고 계신가요.<br>가볍게 생각하다보면 우울상태가 심해질수도 있어요.</p>
					<h5>확인해보세요.</h5>
					<ul>
					...
					<p>우울증을 너무 심하게 받아들일 필요는 없지만 가볍게 생각해서도 안돼요.<br>감기도 가볍게 방치하다간 더 큰 병으로 이어집니다.<br>
					병원을 가는게 부담스러우시다면 저희가 제공하는 모의 집단상담에 참여해보시는건 어떠세요.
					</p>
				</div>
				<div class="col-lg-6">
					<img class="img-fluid rounded" src="images/result3.jpg" alt="" />
				</div>
			</div>
			<!-- /.row -->
		</div>
