...
<body>
	...
	<div class="full-title">
		<div class="container">
			...
			<h1 class="mt-4 mb-3">집단상담예약
				<small>group counseling</small>
			</h1>
		</div>
	</div>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p class="card-text">컴퓨터를 사용하여 상담에 참가하시는 분은 <br>회의용 ZOOM 클라이언트를 다운로드 하세요. <br>스마트폰을 이용하여 상담에 참가하시는 분은 ZOOM 모바일 앱을 다운로드 하세요.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p class="card-text">현재 국가에서 인증받은 전문상담센터에서 <br>근무하는 상담사들의 정보 및 이력을 확인하고 <br>상담 예약을 진행해주세요.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              <p class="card-text">상담 예약 후 제공받으신 상담시간과 ZOOM<br>링크를 통해 ZOOM프로그램에 접속하여 상담을 진행하실 수 있습니다. ZOOM회의에 들어가기 전 자신만 아는 닉네임을 설정하여 익명성을 <br>보장받으세요.</p>
            </div>
          </div>
        </div>
        ...
        <div class="col-lg-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            <a href="#"><img class="card-img-top" src="images/step1.png" alt="" /></a>
            <div class="card-body">
              <h4 class="card-title">
                <a href="https://zoom.us/download">&rarr; ZOOM 다운로드 링크</a>
              </h4>
