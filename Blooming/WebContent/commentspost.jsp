...
<body>
	...
	<div class="full-title">
		<div class="container">
			...
			<h1 class="mt-4 mb-3">극복후기
				<small>post-overcoming review</small>
			</h1>
		</div>
	</div>
    ...
    <div class="container">
		<div class="breadcrumb-main">
			<ol class="breadcrumb">
				...
				<a href="comments.jsp" class="breadcrumb-item active">극복후기 게시판으로 돌아가기</a>
			</ol>
		</div>
        ...
        <!-- Post Content Column -->
            ...
            <div class="col-md-4">
               <a class="btn btn-lg btn-secondary btn-block" href="signup.html">댓글작성하기</a>
            </div>
        </div>
						</form>
					</div>
